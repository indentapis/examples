...
variable "indent_webhook_secret" {
  description = "INDENT_WEBHOOK_SECRET for the indent-gcloud-github-teams pull webhook"
  type        = string
  sensitive   = true
}

variable "github_token" {
  description = "GITHUB_TOKEN for the indent-gcloud-github-teams pull webhook"
  type        = string
  sensitive   = true
}

variable "github_org" {
  description = "GITHUB_ORG for the indent-gcloud-github-teams pull webhook"
  type        = string
  sensitive   = true
}
